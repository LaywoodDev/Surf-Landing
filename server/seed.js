// Начальные данные контента. Дублируют src/data/posts.ts и src/data/events.ts,
// т.к. сервер не может импортировать TS. Используются один раз — при создании
// server/data/content.json; дальше источник правды — сам JSON-файл.
