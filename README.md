...
Лендинг мессенджера **Surf** — маркетинговый сайт с блогом, полной пользовательской документацией, страницей ивентов и админкой для управления контентом.
...
| `/about` | О продукте |
| `/docs` | Полная документация: чаты, группы, каналы, звонки, Opus, AI Recorder, боты, интеграции, Marketplace, настройки и решение проблем |
